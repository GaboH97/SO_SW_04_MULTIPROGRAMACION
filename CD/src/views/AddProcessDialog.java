...
public class AddProcessDialog extends javax.swing.JDialog {
    ...
    public Process createProcess(ArrayList<Process> processes) throws Exception {
        ...
        if (!processNamejtf.getText().isEmpty() && !timeInput.isEmpty() && !sizeInput.isEmpty() && partitionjcb.getSelectedItem() != null) {
    ...
    public JComboBox<Partition> getPartitionjcb() {
        return partitionjcb;
    }
    ...
    public Process editProccess(ArrayList<Partition> partitionsList) {
        Process process = null;
        String timeInput = executionTimejtf.getText();
        String sizeInput = processSizejtf.getText();
        //Verifica que los campos no estén vacíos
